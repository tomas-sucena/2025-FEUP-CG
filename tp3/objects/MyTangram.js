...
export class MyTangram extends MyObject {
    ...
    initMaterials() {
        ...
        this.greenMaterial.setSpecular(0.8, 0.8, 0.8, 1);
        ...
        this.blueMaterial.setSpecular(0.8, 0.8, 0.8, 1);
        ...
        this.redMaterial.setSpecular(0.8, 0.8, 0.8, 1);
        ...
        this.orangeMaterial.setSpecular(0.8, 0.8, 0.8, 1);
        ...
        this.yellowMaterial.setAmbient(0.8, 0.8, 0.8, 1);
        ...
        this.purpleMaterial.setSpecular(0.8, 0.8, 0.8, 1);
        ...
        this.pinkMaterial.setSpecular(0.8, 0.8, 0.8, 1);
