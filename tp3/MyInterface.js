...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        // example of a dropdown that has an associated label
        ...
        this.gui.add(this.scene, 'objectComplexity', 0.01, 1.0)
            .name('Complexity')
            .onChange(this.scene.updateObjectComplexity.bind(this.scene));
        ...
        const f1 = this.gui.addFolder('Light 1 ');
        f1.add(this.scene.lights[1], 'enabled').name("Enabled");
        const sf1 = f1.addFolder('Light 1 Position');
        ...
        const sf2 = f1.addFolder('Light 1 Attenuation');
        ...
        const f2 = this.gui.addFolder('Custom Material');
